...
class Smarty_Security {
     ...
     * {@lib $security} is disabled during their inclusion/execution.
     *
     * @var array
     */
     ...
     * is reduced to "http://hello.world.example.org" prior to applying the patters from {@lib $trusted_uri}.
     * @param string $uri 
