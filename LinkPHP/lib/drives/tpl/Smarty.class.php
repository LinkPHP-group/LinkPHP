...
class Smarty extends Smarty_Internal_TemplateBase {
    ...
    public function enableSecurity($security_class = null)
    {
        if ($security_class instanceof Smarty_Security) {
            ...
            throw new SmartyException("Class '" . get_class($security_class) . "' must ext Smarty_Security.");
        }
        ...
        if (!class_exists($security_class)) {
            ...
            throw new SmartyException("Class '$security_class' must ext Smarty_Security.");
        } else {
     ...
     *
     * @lib http://php.net/set_error_handler
